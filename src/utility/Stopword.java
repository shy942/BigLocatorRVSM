...
public class Stopword {
	...
	static {
		String[] keywords = new String[]{"abstract", "continue", "for", "new", "switch", "assert", "default", "goto",
				...
				"super", "while", "org", "eclipse", "swt", "string", "main", "args", "null", "this", "extends", "true",
				"false"};
		...
		String[] EngStopWord = new String[]{"a", "a's", "able", "about", "above", "according", "accordingly", "across",
